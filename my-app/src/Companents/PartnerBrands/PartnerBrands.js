                ...
                <div className='pb-body' id='partner-brands'>
                    <div className='pb-content'>
                        ...
                        <div className='third-line'>
                            <div className='pb-item pure'><a>Baobab</a></div>
                            <div className='pb-item pure'><a>ENDORPHIA</a></div>
                        </div>
                        <div className='pb-hr'>
            ...
            return (
                <div className='pbmb-body' id='partner-brands'>
                    <div className='pbmb-content'>
                        ...
                        <div className='mb-third-line'>
                            <div className='pbmb-item pure-mb'><a>Baobab</a></div>
                            <div className='pbmb-item pure-mb'><a>ENDORPHIA</a></div>
                        </div>
                    </div>
                </div>
            );
